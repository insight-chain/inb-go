// Copyright 2015 The go-inb Authors
// This file is part of go-inb.
//
// go-inb is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
// the Free Software Foundation, either version 3 of the License, or
// (at your option) any later version.
//
// go-inb is distributed in the hope that it will be useful,
// but WITHOUT ANY WARRANTY; without even the implied warranty of
// MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the
// GNU General Public License for more details.
//
// You should have received a copy of the GNU General Public License
// along with go-inb. If not, see <http://www.gnu.org/licenses/>.

// Package utils contains internal helper functions for go-inb commands.
package utils
...
import (
	...
	"github.com/insight-chain/inb-go/common/fdlimit"
	"github.com/insight-chain/inb-go/consensus"
	"github.com/insight-chain/inb-go/consensus/clique"
	...
	"github.com/insight-chain/inb-go/dashboard"
	"github.com/insight-chain/inb-go/eth"
	"github.com/insight-chain/inb-go/eth/downloader"
	"github.com/insight-chain/inb-go/eth/gasprice"
	"github.com/insight-chain/inb-go/ethdb"
	"github.com/insight-chain/inb-go/ethstats"
	"github.com/insight-chain/inb-go/les"
	"github.com/insight-chain/inb-go/log"
	"github.com/insight-chain/inb-go/metrics"
	"github.com/insight-chain/inb-go/metrics/influxdb"
	"github.com/insight-chain/inb-go/node"
	"github.com/insight-chain/inb-go/p2p"
	"github.com/insight-chain/inb-go/p2p/discv5"
	"github.com/insight-chain/inb-go/p2p/enode"
	"github.com/insight-chain/inb-go/p2p/nat"
	"github.com/insight-chain/inb-go/p2p/netutil"
	"github.com/insight-chain/inb-go/params"
	whisper "github.com/insight-chain/inb-go/whisper/whisperv6"
...
func MakeAddress(ks *keystore.KeyStore, account string) (accounts.Account, error) {
	...
	log.Warn("Please use explicit addresses! (can search via `ginb account list`)")
	log.Warn("-------------------------------------------------------------------")
...
func SetupMetrics(ctx *cli.Context) {
	if metrics.Enabled {
		...
		if enableExport {
			...
			go influxdb.InfluxDBWithTags(metrics.DefaultRegistry, 10*time.Second, endpoint, database, username, password, "ginb.", map[string]string{
				"host": hosttag,
			})
		}
	}
...
func MakeChain(ctx *cli.Context, stack *node.Node) (chain *core.BlockChain, chainDb ethdb.Database) {
	...
	} else if config.Vdpos != nil { //vdpos by ssh begin
		engine = vdpos.New(config.Vdpos, chainDb)
	} else { //vdpos by ssh end
...
// new format.
//
// e.g. ginb account new --keystore /tmp/mykeystore --lightkdf
//
// is equivalent after calling this method with:
//
// ginb --keystore /tmp/mykeystore --lightkdf account new
//
