...
var (
	...
	AllEthashProtocolChanges = &ChainConfig{big.NewInt(1337), big.NewInt(0), big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, new(EthashConfig), nil, nil}
	...
	// This configuration is intentionally not using keyed fields to force anyone
	// adding flags to the config to also have to set these fields.
	AllCliqueProtocolChanges = &ChainConfig{big.NewInt(1337), big.NewInt(0), big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, &CliqueConfig{Period: 0, Epoch: 30000}, nil}
...
type ChainConfig struct {
	...
	Vdpos  *VdposConfig  `json:"vdpos,omitempty"`
}
...
// VdposLightConfig is the config for light node of vdpos
type VdposLightConfig struct {
...
// String implements the stringer interface, returning the consensus engine details.
func (a *VdposConfig) String() string {
	return "vdpos"
}
