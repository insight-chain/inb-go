...
func TestParseEnsAPIAddress(t *testing.T) {
	for _, x := range []struct {
	...
	}{
		{
			...
			value:       "/data/testnet/ginb.ipc",
			endpoint:    "/data/testnet/ginb.ipc",
		},
		{
		...
		},
		{
			...
			value:       "test:/data/testnet/ginb.ipc",
			endpoint:    "/data/testnet/ginb.ipc",
			tld:         "test",
		},
		{
		...
		},
		{
			...
			value:       "314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/ginb.ipc",
			endpoint:    "/data/testnet/ginb.ipc",
		...
		},
		{
			...
			value:       "test:314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/ginb.ipc",
			endpoint:    "/data/testnet/ginb.ipc",
			addr:        common.HexToAddress("314159265dD8dbb310642f98f50C066173C1259b"),
			tld:         "test",
		},
