...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "ginb.ipc", false, filepath.Join(os.TempDir(), "ginb.ipc")},
		{"data", "ginb.ipc", false, "data/ginb.ipc"},
		{"data", "./ginb.ipc", false, "./ginb.ipc"},
		{"data", "/ginb.ipc", false, "/ginb.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "ginb.ipc", true, `\\.\pipe\geth.ipc`},
		{"data", "ginb.ipc", true, `\\.\pipe\geth.ipc`},
