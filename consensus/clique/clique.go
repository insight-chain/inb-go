...
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	newAddrBytes := append(crypto.PrefixToAddress, crypto.Keccak256(pubkey[1:])[13:]...)
...
func (c *Clique) Finalize(chain consensus.ChainReader, header *types.Header, state *state.StateDB, txs []*types.Transaction, uncles []*types.Header, receipts []*types.Receipt, vdposContext *types.VdposContext) (*types.Block, error) {
