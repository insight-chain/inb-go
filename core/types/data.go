...
type Data struct {
	...
	Version          common.Hash        `json:"sha3Uncles"       gencodec:"required"`
	Name         	 []byte     		`json:"miner"            gencodec:"required"`
	Root             common.Hash        `json:"stateRoot"        gencodec:"required"`
	Description      common.Hash   		`json:"transactionsRoot" gencodec:"required"`
	...
	OriginCode           []byte             `json:"reward"           gencodec:"required"`  //2019.6.28 inb by ghy
	ExtraData []byte             `json:"specialConsensus"  gencodec:"required"` //2019.7.23 inb by ghy
...
func (b *Block) GasLimit() uint64     { return b.header.ResLimit }
func (b *Block) GasUsed() uint64      { return b.header.ResUsed }
