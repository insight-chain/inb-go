...
func (b *BlockGen) SetCoinbase(addr common.Address) {
	...
	b.gasPool = new(GasPool).AddGas(b.header.ResLimit)
}
...
func (b *BlockGen) AddTxWithChain(bc *BlockChain, tx *types.Transaction) {
	...
	receipt, _, err := ApplyTransaction(b.config, bc, &b.header.Coinbase, b.gasPool, b.statedb, b.header, tx, &b.header.ResUsed, vm.Config{})
	if err != nil {
		panic(err)
	}
...
func makeHeader(chain consensus.ChainReader, parent *types.Block, state *state.StateDB, engine consensus.Engine) *types.Header {
	...
	return &types.Header{
		...
		ResLimit:     CalcGasLimit(parent, parent.GasLimit(), parent.GasLimit()),
